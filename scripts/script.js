...
//swiper 클래스 대상의 안에 작성했을 땐 swiper가 abosolute를 잡는 relative 기본내장으로 별도 설정을 안해도 되지만 밖에 작성했을 땐 밖 위치 기준으로 그 부모에게 relative 설정을 따로 해줘야 한다!!
...
const snsS = new Swiper('.sns .swiper', {
    ...
    breakpoints:{
        ...
        1200:{slidesPerView:4,},//1200이상일 때 4개
    }
})
//detail swiper
